...
'''
class kyle_gripper_xyz_behaviour_kinova_gen_3_smSM(Behavior):
	'''
	...
	def __init__(self):
		super(kyle_gripper_xyz_behaviour_kinova_gen_3_smSM, self).__init__()
		self.name = 'kyle_gripper_xyz_behaviour_kinova_gen_3_sm'
