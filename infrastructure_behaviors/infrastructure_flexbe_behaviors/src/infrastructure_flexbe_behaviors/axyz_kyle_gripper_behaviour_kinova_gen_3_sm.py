...
from armada_flexbe_behaviors.pickandplacekyle_xyz_sm import PickAndPlaceKyle_xyzSM
...
'''
class axyz_Kyle_Gripper_Behaviour_Kinova_Gen_3SM(Behavior):
	'''
	...
	def __init__(self):
		super(axyz_Kyle_Gripper_Behaviour_Kinova_Gen_3SM, self).__init__()
		self.name = 'axyz_Kyle_Gripper_Behaviour_Kinova_Gen_3'
		...
		self.add_behavior(PickAndPlaceKyle_xyzSM, 'PickAndPlaceKyle_xyz')
	...
	def create(self):
		...
		with _state_machine:
			...
			OperatableStateMachine.add('Reset',
										...
										transitions={'completed': 'PickAndPlaceKyle_xyz', 'failed': 'failed'},
			...
			# x:542 y:418
			OperatableStateMachine.add('PickAndPlaceKyle_xyz',
										self.use_behavior(PickAndPlaceKyle_xyzSM, 'PickAndPlaceKyle_xyz'),
