...
'''
class Kyle_Gripper_GPD_Behaviour_Kinova_Gen_3SM(Behavior):
	'''
	...
	def __init__(self):
		super(Kyle_Gripper_GPD_Behaviour_Kinova_Gen_3SM, self).__init__()
		self.name = 'Kyle_Gripper_GPD_Behaviour_Kinova_Gen_3'
